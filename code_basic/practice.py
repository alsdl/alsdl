...
#슬라이싱
jumin = "123456-7890123"  #jumin deungrokbeonho

print("성별:" + jumin[7])  # []은 번째라는 뜻
print("연:" + jumin[0:2])  # [0:2]는 0번째 숫자부터 2번째 숫자 전까지
print("월:" + jumin[2:4])
print("일:" + jumin[4:6])
print("생년월일:" + jumin[:6])  #처음부터 6번째 숫자까지
print("뒤 7자리:" + jumin[7:])  #7번째 숫자부터 끝까지
print("뒤 7자리(뒤에서부터):" + jumin[-7:])  #뒤에서부터 7번째 숫자까지
